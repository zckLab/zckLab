...
**🛠️ Kompetencje**
- **Języki i technologie:** Python, SQL, REST API, FastAPI, Flask
- **Systemy i środowiska:** Linux / Unix, Docker, Git, CI/CD
- **Embedded & Hardware:** Systemy elektromechaniczne, mikrokontrolery, Arduino, IoT
- **Inżynieria systemowa:** Architektura, skalowalność, diagnostyka techniczna, automatyzacja procesów
